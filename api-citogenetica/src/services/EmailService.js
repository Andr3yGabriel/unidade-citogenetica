...
// --- TEMPLATE 1: PEDIDO DE REDEFINIÇÃO ---
const createPasswordResetHtml = (userName, resetUrl) => {
    return `
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
...
// --- TEMPLATE 2: CONFIRMAÇÃO DE SENHA ALTERADA ---
const createPasswordChangedHtml = (userName) => {
    return `
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
...
// --- FUNÇÃO 2: ENVIAR CONFIRMAÇÃO DE ALTERAÇÃO ---
const sendPasswordChangedEmail = async (userEmail, userName) => {
    ...
    try {
        ...
        // Não lançamos um erro crítico aqui para não quebrar o fluxo do usuário caso o e-mail de notificação falhe.
    }
};
