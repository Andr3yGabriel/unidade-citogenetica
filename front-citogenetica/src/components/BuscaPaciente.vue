            ...
            <div class="dados-paciente">
              ...
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <span class="valor">{{ formatarData(pacienteEncontrado.dateOfBirth) || 'Não informado' }}</span>
                </div>
                <div class="info-item">
                  <span class="label">Nome da mãe:</span>
                  <span class="valor">{{ pacienteEncontrado.motherName || 'Não informado' }}</span>
                </div>
                <div class="info-item">
...
import { buscarPacientePorCpfOuSes } from '@/services/pacienteService';
...
const buscarPaciente = async () => {
  ...
  try {
    const response = await buscarPacientePorCpfOuSes(termoBusca.value.trim());
